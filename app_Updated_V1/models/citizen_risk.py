...
==============================================
Per `Citizen_Risk_Assessment_ML_Module.pdf`:
  ...
  - lets ML and rule-based scores be compared side by side over time
"""
...
class CitizenRiskPrediction(Base):
    ...
    # matching the "no personal data beyond what's already in the
    # existing citizen/org record" principle used across these docs.
